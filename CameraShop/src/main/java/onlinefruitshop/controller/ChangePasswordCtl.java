...
import onlinefruitshop.bean.BaseBean;
...
import onlinefruitshop.model.UserModel;
import onlinefruitshop.util.DataUtility;
import onlinefruitshop.util.DataValidator;
...
public class ChangePasswordCtl extends BaseCtl {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (OP_SAVE.equalsIgnoreCase(op)) {
			...
			ServletUtility.redirect(SOTGView.MY_PROFILE_CTL, request, response);
			return;
		}

		ServletUtility.forward(SOTGView.CHANGE_PASSWORD_VIEW, request, response);
	...
	protected String getView() {
		...
		return SOTGView.CHANGE_PASSWORD_VIEW;
	}
