...
import camerashop.controller.BaseCtl;
import camerashop.controller.SOTGView;
...
public class ServletUtility {
	...
	public static void handleException(Exception e, HttpServletRequest request, HttpServletResponse response)
		...
		ServletUtility.forward(SOTGView.ERROR_CTL, request, response);
		e.printStackTrace();
	}
