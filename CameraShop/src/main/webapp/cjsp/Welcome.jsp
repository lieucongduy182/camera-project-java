<%@page import="camerashop.controller.WelcomeCtl"%>
...
<!-- <section class="jumbotron text-center">
    <div class="container">
        <h1 class="jumbotron-heading">Welcome</h1>
         <p class="lead text-muted mb-0">The Camera Shop
         </p>
    </div>
</section> -->
<div class="container">
    <div class="row">
        <div class="col">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/CameraShop/adminPortal/home">Home</a></li>
                </ol>
            </nav>
        </div>
    </div>
