...
<%@page import="camerashop.controller.UserProductCtl"%>
<%@page import="java.util.List"%>
<%@page import="camerashop.bean.CartBean"%>
<%@page import="camerashop.model.CartModel"%>
<%@page import="camerashop.controller.LoginCtl"%>
<%@page import="camerashop.controller.SOTGView"%>
<%@page import="camerashop.bean.UserBean"%>
...
<link href="/CameraShop/css/style.css" rel="stylesheet" >
...
<nav class="navbar navbar-expand-md navbar-dark bg-dark mb-3">
    <div class="container">
        <a class="navbar-brand" href="/CameraShop/adminPortal/home">DL Camera Shop</a>
