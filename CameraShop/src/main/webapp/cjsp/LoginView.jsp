<%@page import="camerashop.util.DataUtility"%>
        ...
        <div class="col">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="<%=SOTGView.LOGIN_CTL%>">Login</a></li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                   ...
                   <jsp:useBean id="bean" class="camerashop.bean.UserBean"
			...
			<input type="hidden" name="modifiedDatetime"
				value="<%=DataUtility.getTimestamp(bean.getModifiedDatetime())%>">
                        ...
                        <input type="submit" name="operation" class="btn btn-primary text-right" value="<%=LoginCtl.OP_SIGN_UP%>"></div>
